#ifndef __SHAPES_COLLISION_DETECTOR_H__
#define __SHAPES_COLLISION_DETECTOR_H__

#include "Shape.h"

class ShapesCollisionDetector
{
public:
	ShapesCollisionDetector(const Shape& firstShape, const Shape& secondShape);
